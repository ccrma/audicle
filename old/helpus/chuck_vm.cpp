...
#ifdef __AUDICLE_STAT_TRACK__
    AudicleStats::instance()->set_vm_ref( this );
#endif
...
#ifdef __AUDICLE_STAT_TRACK__
    AudicleStats::instance()->activate_shred( shred );
#endif
            // run the shred
            if( !shred->run( this ) )
            {
#ifdef __AUDICLE_STAT_TRACK__
    AudicleStats::instance()->deactivate_shred( shred );
#endif
...
#ifdef __AUDICLE_STAT_TRACK__
    if( shred ) AudicleStats::instance()->deactivate_shred( shred );
#endif
        }
...
#ifdef __AUDICLE_STAT_TRACK__
            AudicleStats::instance()->add_shred( shred );
#endif
            retval = shred->id;
            goto done;
        }
...
#ifdef __AUDICLE_STAT_TRACK__
    AudicleStats::instance()->remove_shred( shred );
#endif
