...
"data/one.wav" => s[1].read;
"data/two.wav" => s[2].read;
"data/three.wav" => s[3].read;
"data/four.wav" => s[4].read;
"data/five.wav" => s[5].read;
"data/six.wav" => s[6].read;
"data/seven.wav" => s[7].read;
"data/eight.wav" => s[8].read;
